...
# معالمُ الخريطة — موزّعةٌ على القارّات كي تُعرَف الجهاتُ منها
MAP_LANDMARKS = {
    "دمشق", "القاهرة", "مكة المكرمة", "بغداد", "الرباط", "الخرطوم",
    "الجزائر", "صنعاء", "مسقط", "نواكشوط",
    "إسطنبول", "طهران", "موسكو", "لندن", "باريس", "برلين", "روما",
    "مدريد", "ستوكهولم", "أثينا",
    "نيودلهي", "بكين", "طوكيو", "جاكرتا", "بانكوك", "كراتشي",
    "نيويورك", "لوس أنجلوس", "مكسيكو سيتي", "شيكاغو",
    "ساو باولو", "بوينس آيرس", "ليما", "بوغوتا",
    "لاغوس", "نيروبي", "جوهانسبرغ", "أديس أبابا", "داكار",
    "سيدني", "بيرث", "أوكلاند",
}
...
def route_astromap(q):
    ...
    **خرائط الأرض** — أين تقع كواكبك على وجه الأرض.
    ...
    data.update({
        ...
        # ــ **المدن معالمُ لا حَشْو** ــ
        # كنّا نرسل ٣٦٤ مدينةً تُرسَم نقاطًا متساوية بلا اسم،
        # فيخرج **حقلُ نقاطٍ مجهولة** لا خريطة. والعين لا تهتدي
        # بنقطةٍ لا اسم لها. فتُرسَل **معالمُ معدودة تُكتَب
        # أسماؤها**، وسائرُ الأطلس يبقى للبحث لا للرسم.
        "cities": [{"n": c["ar"], "lat": round(c["lat"], 2),
                    "lon": round(c["lon"], 2)}
                   for c in atlas.CITIES if c["ar"] in MAP_LANDMARKS],
    })
