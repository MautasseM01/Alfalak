...
const NAV_DOORS = [
  {
    ...
    items: [
      ...
      ['/sky.html', 'مختبر السماء', 'قدّم الزمن وانظر السماء تتحرّك'],
      ['/eclipses.html', 'الكسوف والخسوف', 'العقدة وساروس، وهل يُرى من مدينتك'],
  ...
  },
  {
    ...
    items: [
      ...
      ['/medical.html', 'الملوثيزيا', 'البدن على البروج — تاريخُ فكرة لا طبّ'],
      ['/astromap.html', 'خرائط الأرض', 'أين تقع كواكبك على وجه الأرض'],
      ['/figures.html', 'خرائط المشاهير', 'مواليد الأعلام بما يصحّ بالتاريخ وحده'],
      ['/verify.html', 'أين تُضبَط المعلومة؟', 'قياساتٌ تفعلها بنفسك بدل أن يُقال لك'],
